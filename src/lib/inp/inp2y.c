...
GENERIC *gnode1, *gnode2, *inode1, *inode2;
...
GENERIC *mdfast2, *mdfast3, *mdfast4, *mdfast5, *mdfast6;
GENERIC *fast2, *fast3, *fast4, *fast5, *fast6;
IFvalue ptemp1;  /* a value structure to package resistance into */
IFvalue ptemp2;  /* a value structure to package resistance into */
int waslead;    /* flag to indicate that funny unlabeled number was found */
double leadval; /* actual value of unlabeled number */
IFuid uid;      /* uid for default model */
GENinstance *txl;
IFvalue ptemp;  /* a value structure to package into */
double lval, rval, cval, lenval;
int lenvalgiven = 0;
