...
IFparm BSIM1mPTable[] = { /* model parameters */
...
int	BSIM1nSize = NUMELEMS(BSIM1names);
int	BSIM1pTSize = NUMELEMS(BSIM1pTable);
int	BSIM1mPTSize = NUMELEMS(BSIM1mPTable);
int	BSIM1iSize = sizeof(BSIM1instance);
int	BSIM1mSize = sizeof(BSIM1model);
