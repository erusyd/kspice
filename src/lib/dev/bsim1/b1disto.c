 ...
 */
{
 BSIM1model *model = (BSIM1model *) genmodel;
...
for( ; model != NULL; model = model->BSIM1nextModel ) {
 ...
 here=here->BSIM1nextInstance) {
    ...
    case D_TWOF1:
      ...
      {
        /* draincurrent term */
        r1h1x = *(job->r1H1ptr + here->BSIM1gNode) - 
            *(job->r1H1ptr + here->BSIM1sNodePrime);
        i1h1x = *(job->i1H1ptr + here->BSIM1gNode) - 
            *(job->i1H1ptr + here->BSIM1sNodePrime);

        r1h1y = *(job->r1H1ptr + here->BSIM1bNode) -
            *(job->r1H1ptr + here->BSIM1sNodePrime);
        i1h1y = *(job->i1H1ptr + here->BSIM1bNode) -
            *(job->i1H1ptr + here->BSIM1sNodePrime);

        r1h1z = *(job->r1H1ptr + here->BSIM1dNodePrime) -
            *(job->r1H1ptr + here->BSIM1sNodePrime);

        i1h1z = *(job->i1H1ptr + here->BSIM1dNodePrime) -
            *(job->i1H1ptr + here->BSIM1sNodePrime);
         ...
         *(ckt->CKTrhs + here->BSIM1dNodePrime) -= temp;
         *(ckt->CKTirhs + here->BSIM1dNodePrime) -= itemp;
        
         *(ckt->CKTrhs + here->BSIM1sNodePrime) += temp;
         *(ckt->CKTirhs + here->BSIM1sNodePrime) += itemp;
        ...
        *(ckt->CKTrhs + here->BSIM1gNode) -= temp;
        *(ckt->CKTirhs + here->BSIM1gNode) -= itemp;
        ...
        *(ckt->CKTrhs + here->BSIM1bNode) -= temp;
        *(ckt->CKTirhs + here->BSIM1bNode) -= itemp;
        ...
        *(ckt->CKTirhs + here->BSIM1sNodePrime) += itemp;
        ...
        /* loading here->BSIM1gbs term */

        r1h1x = *(job->r1H1ptr + here->BSIM1bNode) -
            *(job->r1H1ptr + here->BSIM1sNodePrime);
        i1h1x = *(job->i1H1ptr + here->BSIM1bNode) -
            *(job->i1H1ptr + here->BSIM1sNodePrime);
        ...
        *(ckt->CKTirhs + here->BSIM1sNodePrime) += itemp;
        ...
        /* here->BSIM1gbs term over */

        /* loading here->BSIM1gbd term */

        r1h1x = *(job->r1H1ptr + here->BSIM1bNode) -
            *(job->r1H1ptr + here->BSIM1dNodePrime);
        i1h1x = *(job->i1H1ptr + here->BSIM1bNode) -
            *(job->i1H1ptr + here->BSIM1dNodePrime);
    ...
    case D_THRF1:
...

      {
        ...
        r2h11x = *(job->r2H11ptr + here->BSIM1gNode) - 
            *(job->r2H11ptr + here->BSIM1sNodePrime);
        i2h11x = *(job->i2H11ptr + here->BSIM1gNode) - 
            *(job->i2H11ptr + here->BSIM1sNodePrime);

        r2h11y = *(job->r2H11ptr + here->BSIM1bNode) -
            *(job->r2H11ptr + here->BSIM1sNodePrime);
        i2h11y = *(job->i2H11ptr + here->BSIM1bNode) -
            *(job->i2H11ptr + here->BSIM1sNodePrime);

        r2h11z = *(job->r2H11ptr + here->BSIM1dNodePrime) -
            *(job->r2H11ptr + here->BSIM1sNodePrime);

        i2h11z = *(job->i2H11ptr + here->BSIM1dNodePrime) -
            *(job->i2H11ptr + here->BSIM1sNodePrime);
        ...
        *(ckt->CKTirhs + here->BSIM1sNodePrime) += itemp;
        ...
        r2h11x = *(job->r2H11ptr + here->BSIM1bNode) -
            *(job->r2H11ptr + here->BSIM1sNodePrime);
        i2h11x = *(job->i2H11ptr + here->BSIM1bNode) -
            *(job->i2H11ptr + here->BSIM1sNodePrime);
        ...
        *(ckt->CKTirhs + here->BSIM1sNodePrime) += itemp;
        ...
        r2h11x = *(job->r2H11ptr + here->BSIM1bNode) -
            *(job->r2H11ptr + here->BSIM1dNodePrime);
        i2h11x = *(job->i2H11ptr + here->BSIM1bNode) -
            *(job->i2H11ptr + here->BSIM1dNodePrime);
    ...
    case D_F1PF2:
...

      {
        ...
        r1h2x = *(job->r1H2ptr + here->BSIM1gNode) - 
            *(job->r1H2ptr + here->BSIM1sNodePrime);
        i1h2x = (*(job->i1H2ptr + here->BSIM1gNode) - 
            *(job->i1H2ptr + here->BSIM1sNodePrime));

        r1h2y = *(job->r1H2ptr + here->BSIM1bNode) -
            *(job->r1H2ptr + here->BSIM1sNodePrime);
        i1h2y = (*(job->i1H2ptr + here->BSIM1bNode) -
            *(job->i1H2ptr + here->BSIM1sNodePrime));

        r1h2z = *(job->r1H2ptr + here->BSIM1dNodePrime) -
            *(job->r1H2ptr + here->BSIM1sNodePrime);

        i1h2z = (*(job->i1H2ptr + here->BSIM1dNodePrime) -
            *(job->i1H2ptr + here->BSIM1sNodePrime));
        ...
        *(ckt->CKTirhs + here->BSIM1sNodePrime) += itemp;
        ...
        r1h2x = *(job->r1H2ptr + here->BSIM1bNode) -
            *(job->r1H2ptr + here->BSIM1sNodePrime);
        i1h2x = *(job->i1H2ptr + here->BSIM1bNode) -
            *(job->i1H2ptr + here->BSIM1sNodePrime);
        ...
        *(ckt->CKTirhs + here->BSIM1sNodePrime) += itemp;
        ...
        r1h2x = *(job->r1H2ptr + here->BSIM1bNode) -
            *(job->r1H2ptr + here->BSIM1dNodePrime);
        i1h2x = *(job->i1H2ptr + here->BSIM1bNode) -
            *(job->i1H2ptr + here->BSIM1dNodePrime);
    ...
    case D_F1MF2:
...

      {
        ...
        r1hm2x = *(job->r1H2ptr + here->BSIM1gNode) - 
            *(job->r1H2ptr + here->BSIM1sNodePrime);
        i1hm2x = -(*(job->i1H2ptr + here->BSIM1gNode) - 
            *(job->i1H2ptr + here->BSIM1sNodePrime));

        r1hm2y = *(job->r1H2ptr + here->BSIM1bNode) -
            *(job->r1H2ptr + here->BSIM1sNodePrime);
        i1hm2y = -(*(job->i1H2ptr + here->BSIM1bNode) -
            *(job->i1H2ptr + here->BSIM1sNodePrime));

        r1hm2z = *(job->r1H2ptr + here->BSIM1dNodePrime) -
            *(job->r1H2ptr + here->BSIM1sNodePrime);

        i1hm2z = -(*(job->i1H2ptr + here->BSIM1dNodePrime) -
            *(job->i1H2ptr + here->BSIM1sNodePrime));
        ...
        *(ckt->CKTirhs + here->BSIM1sNodePrime) += itemp;
        ...
        r1hm2x = *(job->r1H2ptr + here->BSIM1bNode) -
            *(job->r1H2ptr + here->BSIM1sNodePrime);
        i1hm2x = -(*(job->i1H2ptr + here->BSIM1bNode) -
            *(job->i1H2ptr + here->BSIM1sNodePrime));
    ...
    case D_2F1MF2:
...

      {
        ...
        r2h1m2x = *(job->r2H1m2ptr + here->BSIM1gNode) - 
            *(job->r2H1m2ptr + here->BSIM1sNodePrime);
        i2h1m2x = *(job->i2H1m2ptr + here->BSIM1gNode) - 
            *(job->i2H1m2ptr + here->BSIM1sNodePrime);

        r2h1m2y = *(job->r2H1m2ptr + here->BSIM1bNode) -
            *(job->r2H1m2ptr + here->BSIM1sNodePrime);
        i2h1m2y = *(job->i2H1m2ptr + here->BSIM1bNode) -
            *(job->i2H1m2ptr + here->BSIM1sNodePrime);

        r2h1m2z = *(job->r2H1m2ptr + here->BSIM1dNodePrime) -
            *(job->r2H1m2ptr + here->BSIM1sNodePrime);

        i2h1m2z = *(job->i2H1m2ptr + here->BSIM1dNodePrime) -
            *(job->i2H1m2ptr + here->BSIM1sNodePrime);
        ...
        *(ckt->CKTirhs + here->BSIM1sNodePrime) += itemp;
        ...
        r2h1m2x = *(job->r2H1m2ptr + here->BSIM1bNode) -
            *(job->r2H1m2ptr + here->BSIM1sNodePrime);
        i2h1m2x = *(job->i2H1m2ptr + here->BSIM1bNode) -
            *(job->i2H1m2ptr + here->BSIM1sNodePrime);
        ...
        *(ckt->CKTirhs + here->BSIM1sNodePrime) += itemp;
        ...
        r2h1m2x = *(job->r2H1m2ptr + here->BSIM1bNode) -
            *(job->r2H1m2ptr + here->BSIM1dNodePrime);
        i2h1m2x = *(job->i2H1m2ptr + here->BSIM1bNode) -
            *(job->i2H1m2ptr + here->BSIM1dNodePrime);
