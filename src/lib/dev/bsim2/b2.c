...
IFparm BSIM2mPTable[] = { /* model parameters */
...
int	BSIM2nSize = NUMELEMS(BSIM2names);
int	BSIM2pTSize = NUMELEMS(BSIM2pTable);
int	BSIM2mPTSize = NUMELEMS(BSIM2mPTable);
int	BSIM2iSize = sizeof(BSIM2instance);
int	BSIM2mSize = sizeof(BSIM2model);
