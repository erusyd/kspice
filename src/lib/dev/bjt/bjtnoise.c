    ...
    double *OnDens;
{
    ...
    static char *BJTnNames[BJTNSRCS] = {       /* Note that we have to keep the order */
	".rc",              /* noise due to rc */        /* consistent with the index definitions */
	".rb",              /* noise due to rb */        /* in BJTdefs.h */
	".re",              /* noise due to re */
	".ic",              /* noise due to ic */
	".ib",              /* noise due to ib */
	...
	for (inst=model->BJTinstances; inst != NULL; inst=inst->BJTnextInstance) {
	    switch (operation) {
