...
double cxy;
double r1h1x, i1h1x;		/* 5 arguments */
double r1h1y, i1h1y;
{
...
S2v3F1(cxy, r1h1x, i1h1x, r1h1y, i1h1y,
			r2h11x, i2h11x, r2h11y, i2h11y)

			/* 9 arguments */
double cxy, r1h1x, i1h1x, r1h1y, i1h1y;
double r2h11x, i2h11x, r2h11y, i2h11y;
{
...
S2vF12(cxy, r1h1x, i1h1x, r1h1y, i1h1y,
				r1h2x, i1h2x, r1h2y, i1h2y)

				/* 9 arguments */
double cxy, r1h1x, i1h1x, r1h1y, i1h1y;
double r1h2x, i1h2x, r1h2y, i1h2y;
{
...
S2v2F12(cxy, r1h1x, i1h1x, r1h1y, i1h1y,
				r1h2x, i1h2x, r1h2y, i1h2y,
				r2h11x, i2h11x, r2h11y, i2h11y,
				h2f1f2x, ih2f1f2x, h2f1f2y, ih2f1f2y)

				/* 17 arguments */
double cxy, r1h1x, i1h1x, r1h1y, i1h1y;
double r1h2x, i1h2x, r1h2y, i1h2y;
double r2h11x, i2h11x, r2h11y, i2h11y;
double h2f1f2x, ih2f1f2x, h2f1f2y, ih2f1f2y;
{
return ( cxy * (
...
S3v3F1(cxyz, r1h1x, i1h1x, r1h1y, i1h1y, r1h1z,
				...
				/* 7 arguments */
double cxyz, r1h1x, i1h1x, r1h1y;
double i1h1y, r1h1z,i1h1z;
{
return( cxyz * (
...
S3v2F12(cxyz, r1h1x, i1h1x, r1h1y, i1h1y,
				r1h1z, i1h1z, r1h2x, i1h2x, r1h2y,
				i1h2y, r1h2z, i1h2z)

				/* 13 arguments */
double cxyz, r1h1x, i1h1x, r1h1y, i1h1y;
double r1h1z, i1h1z, r1h2x, i1h2x, r1h2y;
double i1h2y, r1h2z, i1h2z;
{
return ( cxyz * (
...
DFn2F1(cxx,cyy,czz,cxy,cyz,cxz,
			r1h1x,i1h1x,r1h1y,i1h1y,r1h1z,i1h1z)
...
DFn3F1(cxx,cyy,czz,cxy,cyz,cxz,cxxx,cyyy,czzz,cxxy,cxxz,cxyy,cyyz,cxzz,cyzz,cxyz,
			r1h1x,i1h1x,r1h1y,i1h1y,r1h1z,i1h1z,
			r2h11x,i2h11x,r2h11y,i2h11y,r2h11z,i2h11z)
			 /* 28 args - 16 + 6 + 6 */
double cxx,cyy,czz,cxy,cyz,cxz,cxxx,cyyy,czzz,cxxy,cxxz,cxyy,cyyz,cxzz,cyzz,cxyz;
double r1h1x,i1h1x,r1h1y,i1h1y,r1h1z,i1h1z;
double r2h11x,i2h11x,r2h11y,i2h11y,r2h11z,i2h11z;
{
double temp;
...
DFnF12(cxx,cyy,czz,cxy,cyz,cxz,
			r1h1x,i1h1x,r1h1y,i1h1y,r1h1z,i1h1z,
			r1h2x,i1h2x,r1h2y,i1h2y,r1h2z,i1h2z)

			/* 18 args - 6 + 6 + 6	*/
double cxx,cyy,czz,cxy,cyz,cxz;
double r1h1x,i1h1x,r1h1y,i1h1y,r1h1z,i1h1z;
double r1h2x,i1h2x,r1h2y,i1h2y,r1h2z,i1h2z;
{
double temp;
